TW.Runtime.Widgets.Customtable = function () {
    ...
    this.updateProperty = function (updatePropertyInfo) {
        ...
        if (updatePropertyInfo.TargetProperty === "Configuration") {
            this.setProperty(
                "Configuration",
        ...
        if (updatePropertyInfo.TargetProperty === "DataThingworx") {
            this.setProperty(
                "DataThingworx",
                updatePropertyInfo.RawDataFromInvoke.rows
            );
    ...
    this.serviceInvoked = function (serviceName) {
        ...
        d3.select("#buttonimage" + (widgetProps.Filename).slice(0,30) ).on("click")();
    ...
    this.setupWidget = function () {
        ...
        var idRandom =  file_name.slice(0,30) 
        ...
        var imageexport = d3
            ...
            var divbody = d3.select(`#${widgetID}`).append("div").attr("id", "root"+idRandom);
        ...
        function tableToExcel(tableold, name, file_name) {
            ...
            console.log("tableToExcel" , tableold)
            //data
            var sum_count_row_data =
                datatable.length + 1 > 16 ? datatable.length + 1 : 16;
